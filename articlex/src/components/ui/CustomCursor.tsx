...
export const CustomCursor = () => {
  ...
  useEffect(() => {
    ...
    const canEnable = mediaQuery.matches && window.innerWidth >= 1024
  ...
  return (
    <>
      <motion.div
        ...
        animate={{ opacity: isPointer ? 0 : hasMoved ? 1 : 0, scale: isPointer ? 0.5 : 1 }}
      ...
      <motion.div
        ...
        animate={{ opacity: hasMoved ? 1 : 0, scale: isPointer ? 1.25 : 1, backgroundColor: isPointer ? 'rgba(124,58,237,0.2)' : 'rgba(124,58,237,0)' }}
